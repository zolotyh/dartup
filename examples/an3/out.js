...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$1", "js___convertToDart$closure", 4, 0, 9, 2],
    ...
    foo: [function() {
      return "bar!";
    }, "call$0", "main__foo$closure", 0, 0, 10],
    main: function() {
      P.allowInterop(F.main__foo$closure(), {func: 1, ret: P.String});
      $.$get$context().$indexSet(0, "foo2", F.main__foo$closure());
    }
  }, 1]];
...
;
  ...
  $ = new Isolate();
  init.metadata = ["callback", "arguments", "o", "index", "captureThis", "self"];
  init.types = [{func: 1, args: [,]}, {func: 1, ret: P.Null, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.Null, args: [P.Symbol,,]}, {func: 1, ret: P.JsFunction, args: [,]}, {func: 1, ret: [P.JsArray,,], args: [,]}, {func: 1, ret: P.JsObject, args: [,]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: P.String}];
